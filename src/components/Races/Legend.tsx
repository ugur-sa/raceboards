const Legend = () => {
  return (
    <div className="hidden items-center justify-center gap-5 text-[8px] lg:flex lg:text-xs">
      ...
      <div className="flex items-center justify-center gap-2">
        <p>Best sector time</p>
        <div className="h-1 w-1 bg-purple-700 lg:h-3 lg:w-3"></div>
      </div>
      <div className="flex items-center justify-center gap-2">
