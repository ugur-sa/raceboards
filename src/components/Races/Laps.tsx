      ...
      {lapsResponse.Race ? (
        <div className="mt-3 lg:p-5">
          ...
          {response.map((lapsObject, index) => (
            <div
              key={index}
              className="mb-5 flex w-full flex-col gap-5 shadow-2xl"
            >
              ...
              <table className="mb-5 w-full rounded-lg text-center">
                ...
                <tbody>
                  {lapsObject.laps.length > 0 ? (
                          ...
                          <td className="w-16 text-left">
                            {lap.cuts !== 0 ? (
                              <div className="flex items-center gap-1">
                                <p>{lap.lap + 1}</p>
                                <p className="text-[3px] lg:text-xs">
                                  (INVALID)
                                </p>
                              </div>
                            ) : lap.pit === true ? (
                    ...
                    <p className="text-left text-lg font-bold">No laps</p>
                  )}
                </tbody>
              </table>
            </div>
